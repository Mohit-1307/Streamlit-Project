...
def intro():
    ...
    st.write("""
            This is an introduction page. Use the dropdown to navigate to different demos.""")
...
def data_frame_demo():
    ...
    st.write("This page displays a sample data frame.")
...
selected_page = st.sidebar.selectbox("Select a page", options = page_names_to_funcs.keys())
