...
# Containers example
with st.container():
    st.header("This is inside a container")
...
placeholders.write("This is an empty placeholders, useful for dynamic content.")

if st.button("Update Placeholder"):
    placeholders.write("The content of this placeholders has been updates.")
